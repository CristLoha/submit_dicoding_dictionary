...
class MobileAngka extends StatefulWidget {
  const MobileAngka({super.key});

  @override
  State<MobileAngka> createState() => _MobileAngkaState();
}

class _MobileAngkaState extends State<MobileAngka> {
  ...
  void initState() {
    ...
    _streamManager.getStreamKategori('angka').listen((data) {
      setState(() {
        _allData = data.docs;
      });
    });
